...
piwo20_0 <- jagsResult_PIWO0
coni21_0 <- jagsResult_CONI0
bbwo20_2 <- jagsResult
save(bbwo20_2, bbwo20_n2, bbwo20_0, file = "BBWO2020_allmodels.RData")
...
save(jagsData, bbwo20full, bbwo20pc, bbwo20aru, bbwo20noscore, bbwo20scoreonly, file = "BBWO2020_allmodels.RData")
