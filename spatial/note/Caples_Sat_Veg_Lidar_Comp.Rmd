...
tall_forest_variables_4ha %>% #from read_points_output_data.R line 1015 
  ...
  mutate(RAVG = cut(mean_RAVGcbi4_20182019, breaks = c(-1, 0, 4/3,4/3*2,4/3*3), labels = c("unburned", "low", "moderate", "high"))) -> tfv_input
...
# ltplotinput from eda_forest_data_points
...
```
#### Pixel by pixel after - before comparisons
