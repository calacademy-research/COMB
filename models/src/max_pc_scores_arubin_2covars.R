...
# parameters --------------------------------------------------------------
speciesCode <- "YRWA" # must match prefiltering of dataML_model.csv
year <- 2021
threshold <- 0
...
jagsData$burn <- as.numeric(scale(Veg$mean_RAVGcbi_20182019_4ha)) # TODO: should we scale this or no?
