...
```{r}
ggplot(mean_values, aes(mean_psi, psi)) +
  geom_point() +
  geom_smooth(method = "lm") +
  xlab("model") +
  ylab("simulated parameter") +
  labs(title = "psi") +
  xlim(c(0,1)) +
  ylim(c(0,1))

ggplot(mean_values, aes(p11.model, p11.sim)) +
  geom_point() +
  geom_smooth(method = "lm") +
  xlab("model") +
  ylab("simulated parameter") +
...
ggplot(mean_values, aes(p_aru11.model, p_aru11.sim)) +
  geom_point() +
  geom_smooth(method = "lm") +
  xlab("model") +
  ylab("simulated parameter") +
...
ggplot(mean_values, aes(p_aru01.model, p_aru01.sim)) +
  geom_point() +
  geom_smooth(method = "lm") +
  xlab("model") +
  ylab("simulated parameter") +
