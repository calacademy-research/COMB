...
length(data$score) # these should be the same. there are 9 fewer scores than there are ARU visits.
...
bbwo20noscore <- jagsResult.noscore
...
bbwo20scoreonly <- jagsResult.scoreonly



save(jagsData, bbwo20full, bbwo20pc, bbwo20aru, bbwo20noscore, bbwo20scoreonly, file = "BBWO2020_allmodels_32files.RData")
